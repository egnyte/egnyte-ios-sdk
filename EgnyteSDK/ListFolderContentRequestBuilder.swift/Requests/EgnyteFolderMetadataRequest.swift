...
@objc public class EgnyteFolderMetadataRequest: EgnyteBaseRequest {
    ...
    ///   - path: path to folder.
    ///   - allowedLinkTypes: A Boolean value indicating whether response contains information about allowed link types.
    ///   - userPermissions: A Boolean value indicating whether response contains information about current user's permission level on the folder and subfolders.
    ///   - includePermissions: A Boolean value indicating whether response contains information about different users and groups who have permissions along with their permission level.
    ///   - listCustomMetadata: A Boolean value indicating whether response contains custom metadata.
