...
public class CreateLinkRequestBuilder {
    ...
    /// A Boolean value indicating whether if link will be sent via email by Egnyte.
    ...
    /// A Boolean value indicating whether a copy of the link message will be sent to the link creator. Only applies if sendEmail is true. Defaults to *false*.
    ...
    /// A Boolean value indicating whether filename will be appended to the end of the link. Only applies to file links, not folder links.
    public var addFilename: Bool?
    /// A Boolean value indicating whether each recipient's uploaded data will be put into a separate folder. Only applies to upload links.
