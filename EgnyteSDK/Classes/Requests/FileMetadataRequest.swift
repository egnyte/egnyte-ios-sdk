...
@objc public class FileMetadataRequest: EgnyteBaseRequest {
    ...
    ///   - path: path to file.
    ///   - listVersions: Boolean value indicating whether response contains file versions metadata.
    ...
    public convenience init(apiClient: EgnyteAPIClient,
                            path: String,
                            completion: @escaping (() throws -> EgnyteFile) -> Void)  {
