...
class OAuthHelper: OAuthWebDelegate {
    ...
    required init(urlRequest: URLRequest, sharedSecret: String, completion: @escaping ( @escaping AuthResult) -> Void) {
    ...
    func processIntermidateAuthResult(_ urlRequest: URLRequest) -> Bool {
        ...
        if let authCode = code {
            ...
            let exchangeRequest = createExchangeRequest(code: authCode,
                                                        domainURL: domain,
                                                        apiKey: self.queryValue(self.authRequest.url!, key: "client_id")!,
    ...
    func createExchangeRequest(code: String, domainURL: URL, apiKey: String, redirectURI: String, sharedSecret: String, scope: String?) -> URLRequest {
        var requestBodyString = "client_id=" + apiKey
        requestBodyString += "&client_secret=" + sharedSecret
