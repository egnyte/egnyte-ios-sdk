...
@objc public class EgnyteLinkResponse: NSObject {
    ...
    /// Boolean value indicating whether, link will be sent via email by Egnyte.
    public let sendMail: Bool
    /// Boolean value indicating whether a copy of the link message will be sent to the link creator. Only applies if sendMail is true. Defaults to false.
